...
<label for="" id="Label7" style="position:absolute;left:176px;top:0px;width:508px;height:56px;line-height:56px;z-index:9;">Select News Details</label>
...
<a href="<?php echo base_url();?>Redirect/updateNews"><h3><b><font size="10">Click Here To Add Latest News </font></b></h3></a>
...
<tr>
  ...
  <?php
    ...
    foreach ($records as $ndata) {
      ?>

	<tr>
	<td><h3><?= $ndata->news_id?></h3></td>
  <td><h3><?= $ndata->news_text?></h3></td>

	<td><a href="<?php echo base_url();?>Vehicle_ctrl/getNewsDetails?nid=<?php echo  $ndata->news_id;?>"><h3>Update </h3></a></td>

  <td><a href="<?php echo base_url();?>Vehicle_ctrl/deleteNews?nid=<?php echo  $ndata->news_id;?>"><h3>Delete </h3></a></td>

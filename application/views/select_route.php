...
<label for="" id="Label7" style="position:absolute;left:176px;top:0px;width:508px;height:56px;line-height:56px;z-index:9;">Select Route Details</label>
...
<tr>
  ...
  <?php
	...
	<tr>
	<td><h3><?= $rdata->route_id?></h3></td>
  <td><h3><?= $rdata->route?></h3></td>
	<td><a href="<?php echo base_url();?>Vehicle_ctrl/getRouteDetails?rid=<?php echo  $rdata->route_id;?>"><h3>Update </h3></a></td>

  <td><a href="<?php echo base_url();?>Vehicle_ctrl/deleteRoute?rid=<?php echo  $rdata->route_id;?>"><h3>Delete </h3></a></td>

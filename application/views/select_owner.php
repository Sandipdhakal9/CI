...
<label for="" id="Label7" style="position:absolute;left:176px;top:0px;width:508px;height:56px;line-height:56px;z-index:9;">Select Owner Details</label>
...
<tr>
  ...
  <?php
    foreach ($records as $odata) {
      ?>

	<tr>
	<td><h3><?= $odata->owner_id?></h3></td>
  <td><h3><?= $odata->full_name?></h3></td>
  <td><h3><?= $odata->vehicle_id?></h3></td>
  <td><h3><?= $odata->phone_number?></h3></td>
	<td><a href="<?php echo base_url();?>Vehicle_ctrl/getOwnerDetails?oid=<?php echo  $odata->owner_id;?>"><h3>Update </h3></a></td>

  <td><a href="<?php echo base_url();?>Vehicle_ctrl/deleteOwner?oid=<?php echo  $odata->owner_id;?>"><h3>Delete </h3></a></td>

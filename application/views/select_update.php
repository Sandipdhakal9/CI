...
<label for="" id="Label7" style="position:absolute;left:176px;top:0px;width:508px;height:56px;line-height:56px;z-index:9;">Select Vehicle Details</label>
...
// if($records->num_rows()>0){
    foreach ($records as $vdata) {
      ?>

	<tr>
	<td><h3><?= $vdata->vehicle_id?></h3></td>
  <td><h3><?= $vdata->vehicle_name?></h3></td>
  <td><h3><?= $vdata->vehicle_type?></h3></td>
	<td><a href="<?php echo base_url();?>Vehicle_ctrl/getVehicleDetails?vid=<?php echo  $vdata->vehicle_id;?>"><h3>Update </h3></a></td>

  <td><a href="<?php echo base_url();?>Vehicle_ctrl/deleteVehicleDetail"><h3>Delete </h3></a></td>

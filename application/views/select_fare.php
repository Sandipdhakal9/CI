...
<label for="" id="Label7" style="position:absolute;left:176px;top:0px;width:508px;height:56px;line-height:56px;z-index:9;">Select Fare Details</label>
...
<tr>
    ...
    <th><h1>Route </h1></th>
    <th><h1>From Place</h1></th>
    <th><h1>To Place</h1></th>
    <th><h1>Normal Fare(rs)</h1></th>
    <th><h1>Student Fare(rs)</h1></th>
    <th><h1>Update</h1></th>
    <th><h1>Delete</h1></th>
  ...
  <?php
    foreach ($records as $fdata) {
      ?>

	<tr>
	<td><h3><?= $fdata->fare_id?></h3></td>
  <td><h3><?= $fdata->vehicle_id?></h3></td>
  <td><h3><?= $fdata->vehicle_name?></h3></td>
  <td><h3><?= $fdata->route?></h3></td>
  <td><h3><?= $fdata->from_place?></h3></td>
  <td><h3><?= $fdata->to_place?></h3></td>
  <td><h3><?= $fdata->normal_fare?></h3></td>
  <td><h3><?= $fdata->student_fare?></h3></td>
	<td><a href="<?php echo base_url();?>Vehicle_ctrl/getFareDetails?fid=<?php echo  $fdata->fare_id;?>"><h3>Update </h3></a></td>

  <td><a href="<?php echo base_url();?>Vehicle_ctrl/deleteFare?fid=<?php echo  $fdata->fare_id;?>"><h3>Delete </h3></a></td>

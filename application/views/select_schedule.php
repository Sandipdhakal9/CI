...
<label for="" id="Label7" style="position:absolute;left:176px;top:0px;width:508px;height:56px;line-height:56px;z-index:9;">Select Schedule Details</label>
...
<tr>
    <th><h1>Date</h1></th>
    <th><h1>Schedule ID</h1></th>
    <th><h1>Route ID</h1></th>
  ...
  if($records->num_rows()>0){
    foreach ($records->result() as $sdata) {
      ?>

	<tr>
	<td><h3><?= $sdata->date?></h3></td>
  <td><h3><?= $sdata->schedule_id?></h3></td>
  <td><h3><?= $sdata->route_id?></h3></td>
  <td><h3><?= $sdata->vehicle_id?></h3></td>
  <td><h3><?= $sdata->departure_time?></h3></td>
  <td><h3><?= $sdata->arrival_time?></h3></td>


	<td><a href="<?php echo base_url();?>Vehicle_ctrl/getScheduleDetails?sid=<?php echo  $sdata->schedule_id;?>"><h3>Update </h3></a></td>

  <td><a href="<?php echo base_url();?>Vehicle_ctrl/deleteSchedule?sid=<?php echo  $sdata->schedule_id;?>"><h3>Delete </h3></a></td>

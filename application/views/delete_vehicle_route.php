...
<link href="<?PHP echo base_url();?>Assets/CSS/delete_vehicle_route.css" rel="stylesheet">
</head>
<body>
<div id="container">
...
<label for="" id="Label7" style="position:absolute;left:176px;top:0px;width:508px;height:56px;line-height:56px;z-index:5;">Delete Vehicle Routes</label>
...
<form name="Form1" method="post" action="<?PHP echo base_url();?>Vehicle_ctrl/deleteRoute"  id="Form1">
<label for="" id="Label1" style="position:absolute;left:0px;top:0px;width:260px;height:61px;line-height:61px;z-index:0;">Select Route ID</label>
<input type="submit" id="Button1" name="btnDelete" value="Delete" style="position:absolute;left:276px;top:223px;width:219px;height:61px;z-index:1;">
<select name="cmbRouteId" size="1" id="Combobox1" style="position:absolute;left:335px;top:0px;width:310px;height:69px;z-index:2;">

<?php
				
	foreach($records->result() as $Rid){
		?>
	}

	<option style="font-size:25px;" ><?php echo $Rid->route_id;?></option>

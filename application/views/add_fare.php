...
<form  action="<?php echo base_url();?>/Vehicle_ctrl/addFare" method="post">
...
<label for="" id="Label1" style="position:absolute;left:0px;top:86px;width:209px;height:46px;line-height:46px;z-index:3;">Vehicle ID</label>
	...
	<select name="vehicle_id_cmb"  style="position:absolute;left:240px;top:84px;width:273px;height:58px ;">
...
<select name="RouteIdCmb" style="position:absolute;left:240px;top:183px;width:273px;height:58px;">

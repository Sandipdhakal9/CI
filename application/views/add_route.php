...
<link href="<?PHP echo base_url();?>Assets/CSS/add_route.css" rel="stylesheet">
</head>
<body>
<div id="container">
...
<label for="" id="Label7" style="position:absolute;left:176px;top:0px;width:508px;height:56px;line-height:56px;z-index:7;">Add Route Info </label>
...
<form name="Form1" method="post" action="<?PHP echo base_url();?>Vehicle_ctrl/addRoute" id="Form1">
<input type="submit" id="Button1" name="Add Route" value="Add Route" style="position:absolute;left:291px;top:279px;width:178px;height:60px;z-index:0;" tabindex="5">
...
<input type="text" id="Editbox1" style="position:absolute;left:321px;top:0px;width:325px;height:44px;line-height:44px;z-index:2;" name="txtRouteId" value="" tabindex="3" spellcheck="false" placeholder="eg: R5">
<input type="text" id="Editbox3" style="position:absolute;left:321px;top:124px;width:325px;height:44px;line-height:44px;z-index:3;" name="txtRoute" value="" tabindex="3" spellcheck="false" placeholder="eg: Bhaktapur to Gongabu">

...
<input type="submit" id="Button1" onclick="window.location.href='<?PHP echo base_url();?>Redirect/updateProfile';return false;" name="btnUpdateProfile" value="Update Profile" style="position:absolute;left:686px;top:72px;width:210px;height:37px;z-index:3;">
...
<input type="submit" id="Button4" onclick="window.location.href='<?php echo base_url();?>Redirect/search';return false;" name="Search Vehicle" value="Search Details" style="position:absolute;left:471px;top:267px;width:425px;height:55px;z-index:6;">

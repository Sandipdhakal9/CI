...
<a href="<?echo base_url();?>Redirect/index"><img src="<?PHP echo base_url();?>Assets/images/Untitled design.png" id="Image2" alt=""></a></div>
...
<label for="" id="Label7" style="position:absolute;left:176px;top:0px;width:508px;height:56px;line-height:56px;z-index:7;">Delete Vehicle Details</label>
<div id="wb_Form1" style="position:absolute;left:185px;top:120px;width:645px;height:286px;z-index:8;">
<form   action="<?PHP echo base_url();?>Vehicle_ctrl/deleteVehicle"  id="Form1" method="post">
...
<select name="cmb_vehicle_name"  id="Combobox1" style="position:absolute;left:335px;top:0px;width:310px;height:69px;">


  <?php
				
	foreach($details as $vechid){
		?>
	}

	
	<option style="font-size:25px;" ><?php echo $vechid->vehicle_id;?></option>
...
<input type="submit" id="Button1"  value="Delete" style="position:absolute;left:276px;top:225px;width:219px;height:61px;z-index:2;">
</form>
